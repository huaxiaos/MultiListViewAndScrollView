...
public class Demo3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyAdapter adapter1 = new MyAdapter(this, 1, 100);
        mLv1.setAdapter(adapter1);

        MyAdapter adapter2 = new MyAdapter(this, 2, 10);
        ...
        mLv1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(Demo3Activity.this, "lv1 " + position, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        mLv2.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(Demo3Activity.this, "lv2 " + position, Toast.LENGTH_SHORT).show();
            }
        });
