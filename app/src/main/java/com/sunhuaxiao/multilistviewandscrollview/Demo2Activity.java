...
public class Demo2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final MyAdapter adapter1 = new MyAdapter(this, 1, 10);
        ...
        mLv1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(Demo2Activity.this, "lv1 " + position, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        mLv2.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(Demo2Activity.this, "lv2 " + position, Toast.LENGTH_SHORT).show();
            }
        });
